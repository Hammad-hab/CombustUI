from .fltk_bindings import FLTK_WIDGET_POINTER, fl_ready, fl_check, grab_fltk_event, set_id, mjuiGetWindowStatus
    ...
    fn execute(mut self) raises:
        ...
        while isRunning:
            if self.hasMainWindow:
                if not mjuiGetWindowStatus(self.__main_window, 0):
