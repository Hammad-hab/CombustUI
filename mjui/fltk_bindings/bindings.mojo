...
alias MJUISETWINDOWTITLE_DEFINATION= fn(window: FLTK_WIDGET_POINTER, title: StringBytes) -> c_void
...
var mjuiWidgetTextColor = __dll.get_function[MJUIWIDGETTEXTCOLOR_DEFINATION]("set_widget_color")
var mjuiSetSelectionColor = __dll.get_function[MJUISETSELECTIONCOLOR_DEFINATION]("set_widget_color")
