...
alias MJUICREATEBUTTON_DEFINATION= fn(w: Int, h: Int, x: Int, y: Int, id: Int32, label_r: StringBytes) -> FLTK_WIDGET_POINTER
alias MJUICREATECHECKBUTTON_DEFINATION= fn(w: Int, h: Int, x: Int, y: Int, id: Int32, label_r: StringBytes) -> FLTK_WIDGET_POINTER
alias MJUICHECKBUTTONGETSTATE_DEFINATION= fn(checkButton: FLTK_WIDGET_POINTER) -> Int
alias MJUICREATEINPUT_DEFINATION= fn(x: Int, y: Int, w: Int, h: Int, id: Int32, label_r: StringBytes) -> FLTK_WIDGET_POINTER
...
alias MJUISETTEXTPROPERTIES_DEFINATION= fn(label: FLTK_WIDGET_POINTER, size: Int, color: Int, type: Int) -> c_void
